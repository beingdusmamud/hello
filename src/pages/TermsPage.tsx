...
const TermsPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black pb-20">
      <div className="bg-white dark:bg-black dark:border-[#2563ea] border-b p-4">
      ...
      <div className="p-6 bg-white dark:bg-black dark:border dark:border-[#2563ea] max-w-4xl mx-auto">
        <div className="prose prose-gray max-w-none">
          <h2 className="text-2xl font-bold mb-6 dark:text-white">Terms of Service</h2>
          <p className="text-gray-600 dark:text-white/80 mb-6">Last updated: {new Date().toLocaleDateString()}</p>

          <section className="mb-8">
            <h3 className="text-xl font-semibold mb-4 dark:text-white">1. Acceptance of Terms</h3>
            <p className="text-gray-700 dark:text-white/80 mb-4">
              By accessing and using DQUOTE-LOGO, you accept and agree to be bound by the terms and provision of this agreement.
            </p>
          </section>

          <section className="mb-8">
            <h3 className="text-xl font-semibold mb-4 dark:text-white">2. User Content</h3>
            <p className="text-gray-700 dark:text-white/80 mb-4">
